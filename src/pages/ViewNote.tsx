  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            disabled={loading}
            className="flex items-center space-x-2 px-4 py-2 text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-lg transition-all duration-200 disabled:opacity-50"
          >
            {loading ? (
          ...
          <Link
            ...
            className="flex items-center space-x-2 px-4 py-2 text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 rounded-lg transition-all duration-200"
          >
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center space-x-2 px-4 py-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-all duration-200 disabled:opacity-50"
          >
      ...
      <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-lg border border-slate-200/60 dark:border-slate-700/60 rounded-2xl shadow-xl shadow-indigo-500/5 dark:shadow-indigo-400/5 overflow-hidden">
        {/* Header */}
        <div className="p-8 border-b border-slate-200/60 dark:border-slate-700/60">
          <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100 mb-4 leading-tight">
            {note.title}
          </h1>
        ...
        {/* AI Summary */}
        {note.summary && (
          <div className="p-8 border-t border-slate-200/60 dark:border-slate-700/60">
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 border border-indigo-200 dark:border-indigo-800/50 rounded-xl p-6">
